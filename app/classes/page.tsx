            ...
            <div className="grid gap-10 md:grid-cols-2 md:gap-8 lg:grid-cols-3">
              {classTypes.map((cls) => (
                ...
                >
                  ...
                  <a
                    href="/#book"
                    className="mt-auto inline-flex items-center justify-center rounded-xl border border-brand-green bg-brand-green px-3 py-1.5 text-sm font-medium text-white transition hover:bg-brand-green-hover md:self-start md:px-3 md:py-1.5 md:text-lg"
                  >
                    Book
                  </a>
                </div>
